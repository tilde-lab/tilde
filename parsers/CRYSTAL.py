...
class CRYSTOUT(Output):
    ...
    def get_structures(self):
        ...
        if not strucs:
            if self.molecular_case: raise RuntimeError( 'No structure was found!' )
            else:
                self.molecular_case = True
        ...
        for crystal_data in strucs:
            ...
            structures.append(  {'cell': parameters, 'atoms': xyz_atoms, 'periodicity': periodicity}  )
        return structures
